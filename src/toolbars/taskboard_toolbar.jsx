...
const _add_toolbar_item = (props) => 
{
    ...
    const _handle_drag = (e) => {
        if (is_dragging) {
            ...
            props.drag_update_func(props.item_index, true, clientX, clientY);
            if(props.item_index === TASKBOARD_TOOLBAR_ITEMS.TBI_STKNOTE)
            {
    ...
    const _handle_drag_end = (e) => {
        ...
        switch(props.item_index)
        {
            ...
            case TASKBOARD_TOOLBAR_ITEMS.TBI_COMMENT:
            {
                props.item_loc_update_func(clientX, clientY);
    ...
    const _on_tb_item_click = (e, tb_item_idx) => {
        switch(tb_item_idx)
        {
            ...
            case TASKBOARD_TOOLBAR_ITEMS.TBI_MARKER:
            {
                props.on_marker_click();
                break;    
            }
            case TASKBOARD_TOOLBAR_ITEMS.TBI_CURSOR:
            {
                let cursor_type = 'default';
                props.on_pointer_click(cursor_type);
                break;   
            }          
            case TASKBOARD_TOOLBAR_ITEMS.TBI_FILL:  
            {
                props.on_fill_click();
                break;
            }
            case TASKBOARD_TOOLBAR_ITEMS.TBI_ERASER:             
            {
                let cursor_type = `url(${eraser_img_32}) 10 10, auto`;
                props.on_eraser_click(cursor_type);
                break;    
            }            
            case TASKBOARD_TOOLBAR_ITEMS.TBI_SHAPE:    
            {
                // set cursor type
                _set_global_cursor_type('default');
                // trigger renderer
                props.taskboard_rerender_func();
                // request subtoolbar active state
        ...
        <div>
            <div id="taskboard_toolbar_root" style={toolbar_styling}>
                <Box sx={{ '& > :not(style)': { m: 0.5 } }} display="flex" flexDirection={flex_dir}>
                    <_add_toolbar_item item_index={TASKBOARD_TOOLBAR_ITEMS.TBI_CURSOR} tbi_type={TOOLBAR_ITEM_TYPE.CLICKABLE} img_src={pointer_img} img_alt_txt={"Cursor"} 
                    ...
                    />
                    <_add_toolbar_item item_index={TASKBOARD_TOOLBAR_ITEMS.TBI_COMMENT} tbi_type={TASKBOARD_TOOLBAR_ITEMS.DRAGGABLE_CLICKABLE} img_src={comment_img} img_alt_txt={"Comment"} 
                    ...
                    tb_root_height={root_height} tb_item_br={item_br} drag_update_func={update_dragged_item_info} taskboard_rerender_func={props.taskboard_rerender_func} request_taskboard_state_func={props.request_taskboard_state}
                    />
                    <_add_toolbar_item item_index={TASKBOARD_TOOLBAR_ITEMS.TBI_SHAPE} tbi_type={TOOLBAR_ITEM_TYPE.CLICKABLE} img_src={shapes_img} img_alt_txt={"Shape"} 
                    ...
                    drag_update_func={update_dragged_item_info} taskboard_rerender_func={props.taskboard_rerender_func} request_taskboard_state_func={props.request_taskboard_state}
                    />
                    <_add_toolbar_item item_index={TASKBOARD_TOOLBAR_ITEMS.TBI_FILL} tbi_type={TOOLBAR_ITEM_TYPE.DRAGGABLE_CLICKABLE} img_src={fill_img} img_alt_txt={"Fill"} 
                    ...
                    drag_update_func={update_dragged_item_info} taskboard_rerender_func={props.taskboard_rerender_func} request_taskboard_state_func={props.request_taskboard_state}
                    />
                    <_add_toolbar_item item_index={TASKBOARD_TOOLBAR_ITEMS.TBI_MARKER} tbi_type={TOOLBAR_ITEM_TYPE.CLICKABLE} img_src={board_marker_img} img_alt_txt={"Marker"} 
                    ...
                    drag_update_func={update_dragged_item_info} taskboard_rerender_func={props.taskboard_rerender_func} request_taskboard_state_func={props.request_taskboard_state}
                    />
                    <_add_toolbar_item item_index={TASKBOARD_TOOLBAR_ITEMS.TBI_ERASER} tbi_type={TOOLBAR_ITEM_TYPE.CLICKABLE} img_src={eraser_img} img_alt_txt={"Eraser"} 
            ...
            { (is_dragging_tb_item.is_dragging) && (is_dragging_tb_item.item_index === TASKBOARD_TOOLBAR_ITEMS.TBI_STKNOTE) && (
            ...
            { (is_dragging_tb_item.is_dragging) && (is_dragging_tb_item.item_index === TASKBOARD_TOOLBAR_ITEMS.TBI_COMMENT) && (
