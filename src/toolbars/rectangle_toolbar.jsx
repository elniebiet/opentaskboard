...
import increase_rectangle_width_img from '../../res/imgs/line_toolbar/increase_line_width_100x100.png';
import reduce_rectangle_width_img from '../../res/imgs/line_toolbar/reduce_line_width_100x100.png';
...
import { RECTANGLE_TOOLBAR_ITEMS } from './toolbar_globals';
...
const _add_toolbar_item = (props) => 
{
    ...
    const _on_tb_item_click = (e, tb_item_idx) => {
        ...
        switch(tb_item_idx)
        {
            ...
            {
                props.rectangle_tb_item_clicked_notif(RECTANGLE_TOOLBAR_ITEMS.ATBI_COLOUR);
                break;    
            }
            case RECTANGLE_TOOLBAR_ITEMS.ATBI_INCREASE_RECTANGLE_WIDTH:
            {
                e.stopPropagation(); // to keep toolbar active
                props.rectangle_tb_item_clicked_notif(RECTANGLE_TOOLBAR_ITEMS.ATBI_INCREASE_RECTANGLE_WIDTH);
                break;    
            }
            case RECTANGLE_TOOLBAR_ITEMS.ATBI_DECREASE_RECTANGLE_WIDTH:
            {
                e.stopPropagation(); // to keep toolbar active
                props.rectangle_tb_item_clicked_notif(RECTANGLE_TOOLBAR_ITEMS.ATBI_DECREASE_RECTANGLE_WIDTH);
                break;    
            }
            case RECTANGLE_TOOLBAR_ITEMS.ATBI_DELETE:
            {
                props.rectangle_tb_item_clicked_notif(RECTANGLE_TOOLBAR_ITEMS.ATBI_DELETE);
                break;    
            }
            default:
            {
        ...
        case RECTANGLE_TOOLBAR_ITEMS.ATBI_COLOUR:
        {
            return (
                <div id="main_tb_item" onMouseDown={_handle_tb_item_click}>
                        <div 
                            id="rectangle_colour_picker"
                            title={props.img_alt_txt}
                        >
                            <_colour_picker_no_button id={"rectanglecp" + props.id} colour={props.rectangle_bg_colour} width={props.tb_root_width} height={props.tb_root_width} 
                            update_colour_func={props.rectangle_update_colour_func} onclick_func={_do_nothing} />
                        </div>
                </div>
            );
        }
        ...
        <div>
            <div id="note_toolbar_root" style={toolbar_styling_top}>
                <Box sx={{ '& > :not(style)': { m: 0.5 } }} display="flex" flexDirection={"row"}>
                    <_add_toolbar_item item_index={RECTANGLE_TOOLBAR_ITEMS.ATBI_INCREASE_RECTANGLE_WIDTH} img_src={increase_rectangle_width_img} img_alt_txt={"Increase Line Width"} 
                    ...
                    rectangle_tb_item_clicked_notif={props.rectangle_toolbar_item_clicked} rectangle_update_colour_func={props.rectangle_update_colour_func} 
                    rectangle_bg_colour={props.rectangle_bg_colour}
                    />
                    <_add_toolbar_item item_index={RECTANGLE_TOOLBAR_ITEMS.ATBI_DECREASE_RECTANGLE_WIDTH} img_src={reduce_rectangle_width_img} img_alt_txt={"Reduce Line Width"} 
                    tb_item_width={item_width} tb_item_height={item_height} tb_root_width={root_width} tb_root_height={root_height} tb_item_br={item_br} 
                    taskboard_rerender_func={props.taskboard_rerender_func} request_taskboard_state_func={props.request_taskboard_state}
                    rectangle_tb_item_clicked_notif={props.rectangle_toolbar_item_clicked} rectangle_update_colour_func={props.rectangle_update_colour_func} 
                    rectangle_bg_colour={props.rectangle_bg_colour}
                    />
                    <_add_toolbar_item item_index={RECTANGLE_TOOLBAR_ITEMS.ATBI_COLOUR} img_src={unused_colour_img} img_alt_txt={"Colour"} 
                    tb_item_width={item_width} tb_item_height={item_height} tb_root_width={root_width} tb_root_height={root_height} tb_item_br={item_br} 
                    taskboard_rerender_func={props.taskboard_rerender_func} request_taskboard_state_func={props.request_taskboard_state}
                    rectangle_tb_item_clicked_notif={props.rectangle_toolbar_item_clicked} rectangle_update_colour_func={props.rectangle_update_colour_func} 
                    rectangle_bg_colour={props.rectangle_bg_colour}
                    />
                    <_add_toolbar_item item_index={RECTANGLE_TOOLBAR_ITEMS.ATBI_DELETE} img_src={delete_img} img_alt_txt={"Delete"} 
                    tb_item_width={item_width} tb_item_height={item_height} tb_root_width={root_width} tb_root_height={root_height} tb_item_br={item_br} 
                    taskboard_rerender_func={props.taskboard_rerender_func} request_taskboard_state_func={props.request_taskboard_state}
                    rectangle_tb_item_clicked_notif={props.rectangle_toolbar_item_clicked}
                    />
                </Box>
            </div>            
        </div>
...
export default _rectangle_toolbar;