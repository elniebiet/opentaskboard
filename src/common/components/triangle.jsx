            ...
            <div>
                ...
                >
                    ...
                    {/* <rect
                        x={Math.min(triangle_start_pos.x, triangle_end_pos.x)}
                        y={Math.min(triangle_start_pos.y, triangle_end_pos.y)}
                        width={Math.abs(triangle_end_pos.x - triangle_start_pos.x)}
                        height={Math.abs(triangle_end_pos.y - triangle_start_pos.y)}
                        fill="none"
                        rx={filleted * (RECT_FILLET_PERCENTAGE * Math.abs(triangle_end_pos.x - triangle_start_pos.x))}
                        ry={filleted * (RECT_FILLET_PERCENTAGE * Math.abs(triangle_end_pos.y - triangle_start_pos.y))}
                        stroke={colour}
                        strokeWidth={stroke_width}
                        strokeOpacity={1.0}
                        style={{ cursor: "grab", pointerEvents: "all" }}
